...
class Hexagon extends Component {
   ...
   static propTypes = {
      ...
      stopOneOpacity: PropType.number,
      stopTwoOpacity: PropType.number,
   ...
   render() {
      ...
      if (gradientColor1 && gradientColor2 && gradientAngle) {
               ...
               <defs>
                  ...
                  >
                     <stop
                        ...
                        stopOpacity={stopOneOpacity}
                     />
                     <stop
                        offset="100%"
                        stopColor={gradientColor2}
                        stopOpacity={stopTwoOpacity}
                     />
                  </linearGradient>
               </defs>
               <polygon
