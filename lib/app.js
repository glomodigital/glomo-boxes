...
import { ShowcaseTileGroup, ShowcaseTile } from './components/ShowcaseTile'
...
renderComponent(
   'Hexagon with hexStyle propfor controlling the polygon styles by javascript',
   <Hexagon
      width="150px"
      hexStyle={{ stroke: '#000', strokeWidth: '4px', fill: '#fff' }}
   />
)
// Example
