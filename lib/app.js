...
renderComponent(
   ...
   <ShowcaseTile
      tileColor={
         'linear-gradient(149deg, rgba(51,51,51, 0.3), rgba(210,121,55, 0.3))'
      }
      contentColor={'#fff'}
      title={'Title One'}
      subTitle={'01'}
...
renderComponent(
   ...
   <Hexagon
      ...
      height="200px"
      backgroundColor="#CCC"
      backgroundImage="https://static.independent.co.uk/s3fs-public/styles/story_large/public/thumbnails/image/2017/08/10/15/dennis-bergkamp.jpg"
   />
)
...
renderComponent(
   'Hexagon with gradiant color background and drop shadow and child elements',
   <Hexagon
      shadow
      width="266px"
      height="266px"
