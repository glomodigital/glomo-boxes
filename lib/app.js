...
renderComponent(
   ...
   <Hexagon
      ...
      backgroundColor="#CCC"
      backgroundImage={
         'https://i2-prod.mirror.co.uk/incoming/article8017113.ece/ALTERNATES/s615/PAY-David-Ginola.jpg'
      }
   />
)
...
renderComponent(
   'Hexagon with icon',
   <Hexagon width="44px" backgroundColor="#3a5998" icon={facebook} />
)
...
renderComponent(
   ...
   <Hexagon
      ...
      gradientColor1="#4b4b4b"
      gradientColor2="#167b86"
      gradientAngle={120}
   />
)
